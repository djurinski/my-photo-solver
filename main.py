...
def evaluate(image):
    images, boxes = readCharacters(image)
...
evaluate(cv.imread("examples/IMG_20201218_151044.jpg"))
print("next")
evaluate(cv.imread("examples/IMG_20201218_150939.jpg"))
print("next")
evaluate(cv.imread("examples/IMG_20201218_150959.jpg"))
print("next")
evaluate(cv.imread("examples/IMG_20201218_151023.jpg"))
